...
const goodPlanets = planets.filter(function(planets) {
	return planets.temperature >= 253 && planets.temperature <= 323 && planets.distance >= 0.75 && planets.distance <= 1.5 
});
console.log(goodPlanets);